...
import (
	...
	clientset "github.com/ankyhe/k8s-customize-controller/pkg/client/clientset/versioned"
	studentscheme "github.com/ankyhe/k8s-customize-controller/pkg/client/clientset/versioned/scheme"
	informers "github.com/ankyhe/k8s-customize-controller/pkg/client/informers/externalversions/gerystudio/v1"
	listers "github.com/ankyhe/k8s-customize-controller/pkg/client/listers/gerystudio/v1"
)
...
func NewController(
	...
	studentInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(old, new interface{}) {
			oldStudent := old.(*gerystudiov1.Student)
			newStudent := new.(*gerystudiov1.Student)
