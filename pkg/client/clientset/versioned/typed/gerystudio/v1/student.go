...
import (
	...
	scheme "github.com/ankyhe/k8s-customize-controller/pkg/client/clientset/versioned/scheme"
...
func newStudents(c *GerystudioV1Client, namespace string) *students {
	return &students{
		client: c.RESTClient(),
		ns:     namespace,
	}
