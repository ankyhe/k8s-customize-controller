...
import (
	...
	versioned "github.com/ankyhe/k8s-customize-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ankyhe/k8s-customize-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/ankyhe/k8s-customize-controller/pkg/client/listers/gerystudio/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GerystudioV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GerystudioV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&gerystudiov1.Student{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gerystudiov1.Student{}, f.defaultInformer)
}
